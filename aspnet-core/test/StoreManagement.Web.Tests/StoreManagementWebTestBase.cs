...
{
    public abstract class StoreManagementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static StoreManagementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(StoreManagementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<StoreManagementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<StoreManagementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<StoreManagementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<StoreManagementDbContext, Task<T>> func)
        {
            T result;
