...
using StoreManagement.Sessions;
using StoreManagement.Web.Models.Account;
using StoreManagement.Web.Views.Shared.Components.TenantChange;

namespace StoreManagement.Web.Controllers
{
    public class AccountController : StoreManagementControllerBase
    {
